...
```javascript
commonKeysIn = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/utils-common-keys-in@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/utils-common-keys-in@umd/bundle.js"></script>
```
